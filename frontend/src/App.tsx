      ...
      <TripBucketProvider>
        ...
        <Router>
          <Routes>
            ...
            />
            <Route
              path="/CommunityVideos"
              element={
                <RequireAuth>
                  <Wrap name="CommunityVideos">
                    <CommunityVideos />
                  </Wrap>
                </RequireAuth>
              }
