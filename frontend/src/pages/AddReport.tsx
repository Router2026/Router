...
export default function AddReport() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      setSuccess(true);
      setTimeout(
        () => navigate(finalLocationId ? `/POIDetail?id=${finalLocationId}` : '/Reports'),
        1200
      );
    } catch (err: unknown) {
      ...
      <div style={{ maxWidth: 600, margin: '0 auto', padding: '20px 16px', paddingBottom: 100 }}>
            ...
            {REPORT_TYPES.map((type) => (
              <button
                ...
                style={{
                  ...
                  borderRadius: 12,
                  background: formData.report_type === type ? '#f0fdf8' : '#fff',
        ...
        <button
          ...
          style={{
            ...
            fontFamily: 'Heebo, sans-serif',
            transition: 'all 0.2s ease',
            boxShadow: canSubmit ? '0 8px 20px rgba(13, 158, 110, 0.25)' : 'none',
          }}
        >
