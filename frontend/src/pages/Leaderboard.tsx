  ...
  return (
    <div style={{ background: '#f8fafc', minHeight: '100vh' }}>
      ...
      <div style={{
        ...
        <h1 style={{ color: '#fff', fontSize: 24, fontWeight: 900, marginBottom: 4 }}>טבלת מובילים</h1>
        <p style={{ color: 'rgba(255,255,255,0.85)', fontSize: 13 }}>המטיילים הפעילים ביותר</p>
      </div>

      {/* My Rank Card */}
      <div style={{ padding: '0 16px', marginTop: -28, position: 'relative', zIndex: 10, marginBottom: 16 }}>
        <div style={{
          background: '#fff', borderRadius: 20,
          boxShadow: '0 8px 32px rgba(0,0,0,0.10)', padding: '20px',
        }}>
          <div style={{ fontSize: 12, color: '#94a3b8', fontWeight: 600, marginBottom: 4, textAlign: 'right' }}>המיקום שלך</div>
        ...
        {users.map((user, i) => (
          <div key={user.id} style={{
            ...
            <div style={{ textAlign: 'left' }}>
              <div style={{ fontSize: 16, fontWeight: 800, color: '#d97706' }}>{user.xp_points?.toLocaleString()}</div>
