...
export default function ContributePOI() {
  ...
  const handleSubmit = async () => {
    if (!pickedPoint) {
      setError("נא לבחור נקודה על המפה");
      return;
    }
    if (!name.trim()) {
      setError("נא להזין שם למיקום");
      return;
    }
    ...
    return (
      ...
      >
        ...
        >
          ...
          >
            הצוות שלנו יבדוק את המיקום שהגשת. עם האישור תקבל התראה ו-50 XP
            נוספים! 🎉
          </p>
          <button
            onClick={() => navigate("/")}
      ...
      >
        ...
        >
          ...
          <input
            ...
            style={{
              width: "100%",
              border: `2px solid ${name ? "#0d9e6e" : "#e2e8f0"}`,
              borderRadius: 12,
              padding: "12px 14px",
              fontSize: 14,
              fontFamily: "Heebo, sans-serif",
          ...
          >
            {CATEGORIES.map((cat) => (
              <button
                ...
                style={{
                  padding: "10px 6px",
                  border: `2px solid ${category === cat.id ? "#0d9e6e" : "#e2e8f0"}`,
                  borderRadius: 14,
                  background: category === cat.id ? "#f0fdf8" : "#fff",
                  cursor: "pointer",
                  fontFamily: "Heebo, sans-serif",
                  display: "flex",
                  flexDirection: "column",
          ...
          >
            <button
              ...
              style={{
                ...
                fontSize: 13,
                fontWeight: 700,
                cursor: photoUrl.trim() ? "pointer" : "default",
                fontFamily: "Heebo, sans-serif",
                flexShrink: 0,
              }}
            >
