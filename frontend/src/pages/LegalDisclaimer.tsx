    ...
    <div dir="rtl" style={{ minHeight: '100vh', background: '#f8fafc', fontFamily: 'Heebo, sans-serif' }}>
      ...
      <div style={{ maxWidth: 680, margin: '0 auto', padding: '28px 20px 60px' }}>
        ...
        {section('🗺️', 'מסלולים ומיקומים', (
          <p>
            המידע, המיקומים והמסלולים המופיעים באתר מוצגים כהמלצה בלבד ועלולים להכיל אי-דיוקים. בנוסף, המסלולים עשויים להיות מוגבלים לגישה, לדרוש היערכות וציוד מיוחד, או להשתנות בעקבות תנאי מזג אוויר ועונות השנה. חובה לאמת את הנתונים, לבדוק את דרכי הגישה ולוודא את התנאים בשטח לפני כל יציאה לטיול.          </p>
        ))}
