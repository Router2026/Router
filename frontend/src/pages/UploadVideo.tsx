    ...
    <div style={{ background: '#f8fafc', minHeight: '100vh', width: '100%' }}>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <h1 style={{ fontSize: 18, fontWeight: 900, color: '#1a2e2a', flex: 1, textAlign: 'right', margin: 0 }}>העלאת וידאו</h1>
        </div>
      </div>
      ...
      <div style={{ maxWidth: 600, margin: '0 auto', padding: '20px 16px', paddingBottom: 100 }}>
        ...
        <label style={{ cursor: 'pointer', display: 'block', marginBottom: 16 }}>
          ...
          <div style={{
            border: '2px dashed #0d9e6e', borderRadius: 20,
        ...
        <div style={{ background: '#fff', borderRadius: 20, padding: '20px', marginBottom: 16, boxShadow: '0 2px 8px rgba(0,0,0,0.04)' }}>
          ...
          <input
            ...
            style={{
              ...
              borderRadius: 12, fontSize: 15, marginBottom: 16, boxSizing: 'border-box',
              fontFamily: 'Heebo, sans-serif', textAlign: 'right', outline: 'none',
            }}
          />
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 8, marginBottom: 16, direction: 'rtl' }}>
            {REGIONS.map(r => (
              <button
                ...
                style={{
                  padding: '8px 4px', border: `2px solid ${formData.region === r ? '#0d9e6e' : '#e2e8f0'}`,
                  borderRadius: 10, background: formData.region === r ? '#f0fdf8' : '#fff',
          ...
          <textarea
            ...
            rows={3}
            style={{
              width: '100%', padding: '12px', border: '2px solid #e2e8f0', boxSizing: 'border-box',
        ...
        <button
          ...
          style={{
            ...
            background: formData.title && formData.region ? 'linear-gradient(135deg, #7c3aed, #9333ea)' : '#e2e8f0',
            color: formData.title && formData.region ? '#fff' : '#94a3b8',
            fontSize: 16, fontWeight: 800, cursor: formData.title && formData.region ? 'pointer' : 'not-allowed',
