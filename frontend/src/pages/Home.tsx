      ...
      <div style={{ maxWidth: 600, margin: "0 auto", paddingBottom: 120 }}>
        ...
        >
          ...
          >
            ...
            <div
              style={{ textAlign: "right", width: "100%", marginTop: "auto" }}
            >
              <div
                style={{
                  fontSize: 17,
            ...
            {displayRegions.map((region) => (
              ...
              >
                ...
                <div style={{ padding: "12px 14px" }}>
                  <div
                    style={{ fontSize: 14, fontWeight: 800, color: "#1a2e2a" }}
                  >
                    {region.name}
                  </div>
          ...
          >
            {CATEGORIES.map((cat) => (
              ...
              >
                ...
                <span
                  style={{ fontSize: 12, fontWeight: 700, color: "#1a2e2a" }}
                >
                  {cat.name}
                </span>
              </button>
