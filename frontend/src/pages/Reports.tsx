...
export default function Reports() {
  ...
  const filtered =
    selectedType === 'הכל' ? reports : reports.filter((r) => r.report_type === selectedType);
            ...
            return (
              ...
              >
                <div style={{ padding: '16px 16px 12px' }}>
                  ...
                  >
                    ...
                    <div style={{ display: 'flex', gap: 6 }}>
                      ...
                      <span
                        style={{
                          background: '#f8fafc',
                          color: SEVERITY_COLORS[report.severity] || '#64748b',
                          borderRadius: 8,
                          padding: '3px 10px',
                          fontSize: 11,
                          fontWeight: 700,
                  ...
                  <div
                    style={{ fontSize: 14, color: '#64748b', textAlign: 'right', lineHeight: 1.5 }}
                  >
                    {report.content}
                  </div>
                </div>
                ...
                >
                  ...
                  >
                    <svg
                      ...
                      height="14"
                      viewBox="0 0 24 24"
                      fill={votedIds.has(report.id) ? 'currentColor' : 'none'}
                      stroke="currentColor"
                      strokeWidth="2"
                      strokeLinecap="round"
                      strokeLinejoin="round"
