...
// Fix 10: show loading state before data arrives (no premature "no reports").
// Sync with real DB via api.reports.list()
      ...
      <div style={{ background: 'linear-gradient(160deg, #d97706 0%, #f59e0b 100%)', width: '100%' }}>
        <div style={{ maxWidth: 600, margin: '0 auto', padding: '48px 20px 40px', display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
          <button onClick={() => navigate('/AddReport')}
            style={{ background: '#fff', border: 'none', borderRadius: 12, padding: '8px 16px', cursor: 'pointer', color: '#d97706', fontSize: 13, fontWeight: 800, display: 'flex', alignItems: 'center', gap: 6, fontFamily: 'Heebo, sans-serif', boxShadow: '0 4px 12px rgba(0,0,0,0.1)' }}>
