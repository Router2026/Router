    ...
    <div style={{ background: '#f8fafc', minHeight: '100vh', width: '100%' }}>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ textAlign: 'right' }}>
            <h1 style={{ color: '#fff', fontSize: 24, fontWeight: 900, marginBottom: 4 }}>וידאו קהילתי</h1>
      ...
      <div style={{ maxWidth: 600, margin: '0 auto', paddingBottom: 100 }}>
        ...
        <div style={{ padding: '16px 16px 8px' }}>
          <div style={{ display: 'flex', gap: 8, overflowX: 'auto', scrollbarWidth: 'none', paddingBottom: 4, direction: 'rtl' }}>
            {TAGS.map(tag => (
              <button
                key={tag}
          ...
          {videos.map(video => (
            <div key={video.id} style={{
              ...
              <div style={{ padding: '14px 16px' }}>
                <div style={{ fontSize: 16, fontWeight: 800, color: '#1a2e2a', marginBottom: 10, textAlign: 'right' }}>
                  {video.title}
                </div>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                  <div style={{ display: 'flex', gap: 12 }}>
                    ...
                    >
                      <svg width="16" height="16" viewBox="0 0 24 24" fill={likedIds.has(video.id) ? 'currentColor' : 'none'} stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
